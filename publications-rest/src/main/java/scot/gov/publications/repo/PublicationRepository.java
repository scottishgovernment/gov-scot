...
public interface PublicationRepository {
    ...
    ListResult list(int page, int size, String title, String isbn, String filename, String username, String sort, String dir) throws PublicationRepositoryException;
}
