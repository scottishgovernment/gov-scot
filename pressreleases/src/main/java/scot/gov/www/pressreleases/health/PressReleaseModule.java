...
/**
 * PressReleasesModule to register the healthcheck endpoint for press release importer
 */
public class PressReleaseModule extends AbstractReconfigurableDaemonModule {
