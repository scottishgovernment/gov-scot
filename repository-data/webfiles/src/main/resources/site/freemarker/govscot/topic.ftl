                        ...
                        <article class="listed-content-item__article">
                            ...
                            <header class="listed-content-item__heading">
                                <#if item.label?has_content>
                                    <#assign date = (item.latestUpdateDate)!(item.publicationDate)!item.properties['hippostdpubwf:lastModificationDate'] />
                                    <div class="listed-content-item__meta">
                                        <div class="listed-content-item__meta-right">
                                            <p class="listed-content-item__date"><@fmt.formatDate value=date.time type="both" pattern="dd MMM yyyy"/></p>
                                        </div>
                ...
                <#if publications?has_content>
                    <#list publications as publication>
                        <article class="homepage-publication">
                            ...
                            <#assign latestDate = (publication.latestUpdateDate)!(publication.publicationDate) />
                            <p class="homepage-publication__date"><@fmt.formatDate value=latestDate.time type="both" pattern="dd MMM yyyy"/></p>
                        </article>
                    </#list>
                <#else>
                ...
                <#if consultations?has_content>
                    <#list consultations as consultation>
                        <article class="homepage-publication">
                            ...
                            <#assign latestDate = (consultation.latestUpdateDate)!(consultation.publicationDate) />
                            <p class="homepage-publication__date"><@fmt.formatDate value=latestDate.time type="both" pattern="dd MMM yyyy"/></p>
                        </article>
                    </#list>
                <#else>
