                                    ...
                                    <#list topics as item>
                                        <#if hstRequestContext.servletRequest.parameterMap["topic"]??>
                                            <#list hstRequestContext.servletRequest.parameterMap["topic"] as selectedItem>
                                                <#if selectedItem == strSlug(item.title)>
                                                    <#assign count = count + 1 />
                                                </#if>
                                            </#list>
                                        </#if>
                                ...
                                <div class="ds_search-filters__scrollable">
                                    <div class="ds_search-filters__checkboxes">
                                        <#list topics as item>
                                            ...
                                            <#if hstRequestContext.servletRequest.parameterMap["topic"]??>
                                                <#list hstRequestContext.servletRequest.parameterMap["topic"] as selectedItem>
                                                    <#if strSlug(selectedItem) == strSlug(item.title)>
                                                        <#assign isSelected = true/>
                                                    </#if>
                                                </#list>
                                            </#if>
                                            ...
                                            <div class="ds_checkbox  ds_checkbox--small">
                                                <input
                                                    ...
                                                    id="${strSlug(item.title)}" name="topic" value="${strSlug(item.title)}" class="ds_checkbox__input" type="checkbox">
                                                <label for="${strSlug(item.title)}" class="ds_checkbox__label">${item.title}</label>
                                            </div>
                                        </#list>
                                    </div>
                                </div>
