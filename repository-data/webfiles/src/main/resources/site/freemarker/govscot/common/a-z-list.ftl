            ...
            <ul class="gov_az-list__list">
                <#list letter.beans as bean>
                    <li class="gov_az-list__list__item">
                        ...
                        <a class="gov_az-list__link" href="${link}">${bean.title}<#if bean.active?? && !bean.active><span class="visually-hidden"> (inactive)</span></#if></a><#if  bean.active?? && !bean.active><strong class="ds_tag  ds_tag--grey" aria-hidden="true">Inactive</strong></#if>
                    </li>
                </#list>
            </ul>
        </li>
