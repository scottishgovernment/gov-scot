...
<div class="gov_document-info <#if attachedDocument.highlighted || (isLimelitItem)!false>gov_document-info--highlight</#if>">
    ...
    <div class="gov_document-info__body">
        <div class="gov_document-info__thumbnail  gov_document-info__thumbnail--pdf">
            <#if filenameExtension == "PDF">
                <a tabindex="-1" class="gov_document-info__thumbnail-link" href="${documentinline}">
