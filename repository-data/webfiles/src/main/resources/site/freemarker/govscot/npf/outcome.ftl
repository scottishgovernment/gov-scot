...
<#if document??>
    ...
    <div class="ds_wrapper">
        <main id="main-content" class="ds_layout  gov_layout--npf-outcome">
                                        ...
                                        <div class="ds_card__content">
                                            <div class="ds_card__content-header">
                                                <h2 class="ds_card__title">
                                                    <a class="ds_card__link  ds_card__link--cover" href="<@hst.link hippobean=indicator/>">${indicator.title}</a>
                                                </h2>
                                            </div>
...
<#if document??>
    ...
    <@hst.headContribution category="dcMeta">
        <meta name="dc.format" content="NPF Outcome"/>
    </@hst.headContribution>
