            ...
            <ul class="gov_social-links">
                ...
                <li class="gov_social-links__item">
                    <a title="X" class="gov_social-links__link" href="https://x.com/scotgov" data-footer="social-2">
                        <div class="gov_social-links__link-inner">
                            <span class="gov_social-links__icon"><svg class="ds_icon" aria-hidden="true" role="img"><use href="${iconspath}#x"></use></svg></span>
                            <span>X</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="gov_social-links__item">
                    <a title="LinkedIn" class="gov_social-links__link" href="https://www.linkedin.com/company/thescottishgovernment/" data-footer="social-6">
                        <div class="gov_social-links__link-inner">
                            <span class="gov_social-links__icon"><svg class="ds_icon" aria-hidden="true" role="img"><use href="${iconspath}#linkedin"></use></svg></span>
                            <span>LinkedIn</span>
                        </div>
                    </a>
                </li>
                <li class="gov_social-links__item">
                    <a title="Tiktok" class="gov_social-links__link" href="https://www.tiktok.com/@scotgov" data-footer="social-7">
                        <div class="gov_social-links__link-inner">
