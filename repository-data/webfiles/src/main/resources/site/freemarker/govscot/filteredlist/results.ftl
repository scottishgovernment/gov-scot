                        ...
                        <div class="listed-content-item__meta">
                            ...
                            <#if item.publicationDate??>
                                ...
                                <#elseif hst.isBeanType(item, "scot.gov.www.beans.Publication")>
                                    <#assign publishedDate = (item.latestUpdateDate)!(item.publicationDate) />
                                </#if>
                                <span class="listed-content-item__date">| <@fmt.formatDate value=publishedDate.time type="both" pattern=dateFormat /></span>
                            </#if>
                        </div>
