                    ...
                    <header class="listed-content-item__header">
                        <div class="listed-content-item__meta">
                            ...
                            <#if item.publicationDate??>
                                ...
                                <#assign publishedDate = item.publicationDate.time />
                                ...
                                <#elseif hst.isBeanType(item, "scot.gov.www.beans.Publication")>
                                    <#assign publishedDate = (item.latestUpdateDate.time)!(item.publicationDate.time) />
                                </#if>
                                <span class="listed-content-item__date">| <@fmt.formatDate value=publishedDate type="both" pattern=dateFormat /></span>
                            </#if>
                        </div>
