  ...
  <#break>
    ...
    <div class="ds_wrapper">
        <div class="ds_pb__inner">
            <#if document??>
                <div class="ds_cp__poster">
                    <a target="_blank" class="ds_pb__poster__link" href="${document.videoUrl}">
                        <#if document.image.xlargesixcolumns??>
                            <img alt="${document.alt}" src="<@hst.link hippobean=document.image.xlargesixcolumns />"
                                class="ds_pb__poster-video"
                                ...
                                >
                        <#else>
                            <img class="ds_pb__poster-video" src="<@hst.link hippobean=document.image />" alt="" width="${document.image.original.width?c}" height="${document.image.original.height?c}">
                        </#if>

                        <svg class="ds_pb__poster__overlay" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 160 90">
