...
public class MetricsCollectingFunnelbackImpl implements Funnelback {
    ...
    MetricsCollectingFunnelbackImpl(Funnelback funnelback) {
        ...
        this.requestTimes = metricsRegistry.timer(MetricName.REQUEST_TIMES.getMetricName());
        this.requestCounter = metricsRegistry.counter(MetricName.REQUESTS.getMetricName());
        this.errorCounter = metricsRegistry.counter(MetricName.ERRORS.getMetricName());
        this.requestMeter = metricsRegistry.meter(MetricName.REQUEST_RATE.getMetricName());
        this.errorMeter = metricsRegistry.meter(MetricName.ERROR_RATE.getMetricName());
    }
